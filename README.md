...
📍 北京, 中国  
📧 dinglei@liansuo.com  
🌐 [微博](https://weibo.com/u/2684814901)  
出生：1983-01-25 ｜ 籍贯：安徽
...
- 创立公司并主导核心技术架构与研发团队建设。  
- 负责后端架构设计、性能与安全策略制定，核心栈为 PHP + MySQL + Apache/Nginx。  
- 主导开发基于 Symfony 的竞价广告管理系统（投放、竞价、结算、数据分析）。  
- 搭建基础设施能力：CDN、域名解析、负载均衡、SSL 管理、运维自动化。  
- 推动前后端分离与模块化改造，为向现代全栈与云原生架构过渡奠定基础。  
- 在 CTO / 创始团队角色中协调产品、运营与市场，确保技术方案与业务目标高度一致。

### 商机在线（北京）网络技术有限公司
技术工程师 → CTO → 运营负责人  
2005 — 2010（北京）

- 参与并主导核心网站与后台系统建设，构建 CMS 与会员体系。  
- 负责广告系统与后台管理系统的设计与性能优化。  
- 作为 CTO 与运营负责人期间，结合技术与数据推动业务增长与平台升级。
...
我见证并参与了国内互联网从 LAMP 时代向现代全栈与 AI 驱动产品的演进。擅长用工程化方法解决业务问题，能够在产品设计、系统建设与团队协作之间建立起高效连接。近期专注于将 AI 能力融入生产力工具与内容创作流程，致力于用智能化提升个人与团队的创造效率。

---

## 📫 联系 / Contact

- 邮箱：dinglei@liansuo.com  
